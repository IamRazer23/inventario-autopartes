 ...
 * Ubicación: views/admin/usuarios/editar.php
 * 
 * @author Grupo 1SF131
 */

// Determinar que es edición
$esEdicion = true;
$titulo = 'Editar Usuario';
$urlAction = BASE_URL . '/index.php?module=admin&action=usuario-update';
                    ...
                    <div class="mb-6">
                        ...
                        >
                            ...
                            <?php else: ?>
                                ...
                                <option value="2" <?= $usuario['rol_id'] == 2 ? 'selected' : '' ?>>Operador</option>
            ...
            <div class="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-lg shadow-md p-6 text-white mb-6">
                ...
                <div class="space-y-3 text-sm">
                    ...
                    <div>
                        ...
                        <p class="font-semibold"><?= isset($usuario['fecha_creacion']) ? formatDate($usuario['fecha_creacion']) : 'N/A' ?></p>
                    </div>
                    <?php if (isset($usuario['ultima_sesion']) && $usuario['ultima_sesion']): ?>
                        <div>
